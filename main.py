...
FILENAME:       main.py
SPECIFICATION:  This file contains the main class for the flappy bird game and it's execution.
...
def img_tensor(img):
        ...
        NAME: img_tensor
        PARAMETERS:
        img: numpy array of shape (width, height, channels)
        PURPOSE: Convert the given numpy array image to a PyTorch tensor
        PRECONDITIONS: The image array should be of shape (width, height, channels) PyTorch, numpy and PIL should be installed
        POSTCONDITIONS: Returns a PyTorch tensor of shape (1, channels, 112, height) that has been resized to 112 x height pixels
        """
